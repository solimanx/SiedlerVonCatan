...
//
// public MainViewController(ViewController vc, Board board, Stage
// mainViewStage) {
...
// System.out.println("Clicked on Village " + villageCoordinates[0] + " , " +
...
// System.out.println("Clicked on Street " + streetCoordinates[0] + " , " +
// streetCoordinates[1] + " , "
// + streetCoordinates[2]);
// viewController.getClientController().requestBuildStreet(streetCoordinates[0],
// streetCoordinates[1],
// streetCoordinates[2]);
//
// }
...
// System.out.println(
// "Clicked on " + fieldCoordinates[0] + " , " + fieldCoordinates[1] + " , " +
// fieldCoordinates[2]);
//
// }
//
...
// }
//
// public void setCorner(int x, int y, int dir, CornerStatus village, int
// playerId) {
// // TODO Auto-generated method stub
//
// }
...
// {
// view.setFieldResourceType(u, v,
// viewController.fieldColors.get(resourceType));
